    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/50 to-white mask-fade-bottom" />
          <div className="absolute inset-0 bg-gradient-to-r from-white/40 to-transparent" />
        </div>

        {/* Decorative blurred shapes */}
        <div className="absolute top-20 -left-20 w-96 h-96 rounded-full bg-sky-200/30 blur-3xl pointer-events-none" />
        <div className="absolute bottom-20 right-10 w-80 h-80 rounded-full bg-teal-200/25 blur-3xl pointer-events-none" />
        <div className="absolute top-1/3 right-1/4 w-48 h-48 rounded-full bg-amber-200/20 blur-2xl pointer-events-none" />
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-xl">
              <div className="animate-fade-up">
                <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-sky-50/80 border border-sky-200/50 text-xs font-semibold tracking-wider text-sky-600 uppercase mb-8">
              ...
              <h1 className="animate-fade-up-d1 text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tight leading-[0.85]">
                <span className="text-sky-900">Tides</span>
                <br />
              ...
              <div className="animate-fade-up-d3 mt-10 flex flex-wrap gap-4">
                ...
                <Link
                  to="/about"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-sky-200 text-sky-700 text-sm font-semibold transition-all duration-300 hover:border-sky-400 hover:bg-sky-50/80 hover:shadow-lg hover:shadow-sky-100"
                >
                  Behind The Waves
                </Link>
              </div>
            ...
            <div className="hidden lg:flex items-center justify-center animate-fade-in">
              <div className="relative">
                ...
                <div className="w-80 h-80 rounded-full bg-gradient-to-br from-sky-100/60 via-teal-50/40 to-amber-50/60 flex items-center justify-center shadow-2xl shadow-sky-200/30">
        ...
        {/* Scroll indicator */}
        <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 z-10 transition-opacity duration-700 ${scrolled ? 'opacity-0' : 'opacity-100'}`}>
          <div className="flex flex-col items-center gap-2">
            <span className="text-xs text-slate-500 font-medium tracking-wider uppercase">Scroll</span>
            <div className="w-5 h-8 rounded-full border-2 border-sky-200 flex justify-center pt-1.5">
      ...
      <section className="w-full px-6 md:px-16 lg:px-24 py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <Link to={`/blog/${featured.id}`} className="group block card-bento p-8 md:p-12">
            <div className="flex flex-col lg:flex-row lg:items-center gap-8">
              ...
              <div className="hidden lg:flex w-24 h-24 rounded-2xl bg-gradient-to-br from-sky-50 to-teal-50 items-center justify-center border border-sky-100 shrink-0 group-hover:scale-105 transition-transform duration-300">
      ...
      <section className="w-full px-6 md:px-16 lg:px-24 py-12 md:py-16 bg-gradient-to-b from-white to-sky-50/50">
        <div className="max-w-7xl mx-auto">
            ...
            {latestTales.map((tale, i) => {
              ...
              return (
                <Link
                  key={tale.id}
                  to={`/blog/${tale.id}`}
                  className={`group card-bento p-6 md:p-8 animate-fade-up`}
          ...
          <div className="mt-8 text-center">
            <Link
              to="/blogs"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-sky-900 text-white text-sm font-semibold hover:bg-sky-800 transition-all shadow-lg shadow-sky-900/20 hover:shadow-xl hover:shadow-sky-900/30 active:scale-[0.98]"
            >
              View All Tales
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {topCategories.map((cat) => (
              <Link
                ...
                className="group px-6 py-3.5 rounded-xl border border-sky-100 bg-white text-sm font-medium text-slate-600 shadow-sm hover:border-sky-300 hover:text-sky-700 hover:shadow-md hover:shadow-sky-100/50 transition-all duration-300 active:scale-[0.97]"
              >
            ...
            <Link
              to="/blogs"
              className="px-6 py-3.5 rounded-xl bg-sky-50 text-sm font-medium text-sky-600 border border-sky-100 hover:bg-sky-100 hover:text-sky-700 transition-all duration-300"
            >
              + All Categories
            </Link>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {marineLifeTales.map((tale) => (
                <Link key={tale.id} to={`/blog/${tale.id}`} className="group card-bento p-6 md:p-8">
                  <h3 className="text-lg font-bold text-sky-900 group-hover:text-sky-700 transition-colors leading-snug">{tale.title}</h3>
                  ...
                  <div className="mt-6 pt-4 border-t border-sky-50 flex items-center justify-between">
                    ...
                    <span className="text-xs text-sky-500 font-medium opacity-0 group-hover:opacity-100 transition-opacity">Read →</span>
                  </div>
                </Link>
              ))}
            </div>
              ...
              {conservationTales.map((tale) => (
                <Link key={tale.id} to={`/blog/${tale.id}`} className="group card-bento p-6 md:p-8">
                  ...
                  <div className="mt-6 pt-4 border-t border-emerald-50 flex items-center justify-between">
                    <span className="text-xs text-slate-400">{tale.readTime}</span>
                    <span className="text-xs text-emerald-500 font-medium opacity-0 group-hover:opacity-100 transition-opacity">Read →</span>
                  </div>
                </Link>
              ))}
            </div>
      ...
      <section className="w-full px-6 md:px-16 lg:px-24 py-12 md:py-16 bg-gradient-to-b from-white to-sky-50/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-6 grid-cols-2 md:grid-cols-4">
            {sketchImages.map((img, i) => (
              <div key={i} className="group cursor-pointer" onClick={() => setLightboxImage(img)}>
                <div className="relative rounded-2xl overflow-hidden border border-sky-100 shadow-premium">
                  <img
                    src={img.src}
                    alt={img.alt}
                    className="w-full h-52 md:h-72 object-cover transition-transform duration-700 group-hover:scale-110"
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center p-5">
                ...
                <p className="mt-3 text-xs text-slate-500 font-medium text-center">{img.label}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 text-center">
            <Link
              to="/library"
              className="inline-flex items-center gap-2 text-sm text-sky-600 font-semibold hover:text-sky-700 transition"
            >
      ...
      <section className="w-full px-6 md:px-16 lg:px-24 py-12 md:py-16 bg-gradient-to-b from-sky-50/50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-sky-100 to-teal-50 mx-auto flex items-center justify-center shadow-lg shadow-sky-100/50 border border-white/60">
            <span className="text-3xl text-sky-500">~</span>
          </div>
          <p className="text-xs font-semibold tracking-widest text-teal-500 uppercase mt-6 mb-3">Beneath The Surface</p>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-sky-900 tracking-tight">
            Hi, I'm Neha.
          </h2>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-12">
            <div>
              ...
              <p className="text-xs text-slate-600 mt-1 font-medium">Tales Written</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black text-teal-700">10</p>
              <p className="text-xs text-slate-600 mt-1 font-medium">Research Docs</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black text-sky-700">∞</p>
              <p className="text-xs text-slate-600 mt-1 font-medium">Tides to Explore</p>
            </div>
          </div>
          <div className="mt-10">
            <Link
